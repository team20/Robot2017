...
public class RocketScript {
	...
	public String[] testCode() {
		...
		autoCode[0] = fastDriveStraight + ";"  + "50.00";
	...
	public String[] gearToPeg(){
		String[] autoCode = new String[3];
		autoCode[0] = fastDriveStraight + ";" + "98.5";
		autoCode[1] = rocketTurn + ";" + "-60.00";
		autoCode[2] = fastDriveStraight + ";" + "12.00";
		return autoCode;
	...
	public String[] rawDriveTurnLeft(){
		...
		autoCode[0] = fastDriveStraight + ";" + AutoConstants.CROSS_BASELINE_DISTANCE;
	...
	public String[] rightGear(){
		String[] autoCode = new String[5];
		autoCode[0] = fastDriveStraight + ";" + AutoConstants.RIGHT_PEG_HARD_DISTANCE;
		autoCode[1] = rocketTurn + ";" + AutoConstants.RIGHT_PEG_HARD_ANGLE;
		autoCode[2] = getCameraAngle + ";" + "NULL";
		autoCode[3] = turnCameraAngle + ";" + "NULL";
		autoCode[4] = goCameraDistance + ";" + "NULL";
	...
	public String[] leftGear(){
		String[] autoCode = new String[5];
		autoCode[0] = fastDriveStraight + ";" + AutoConstants.LEFT_PEG_HARD_DISTANCE;
	...
	public String[] boilerToClosestSideGear(){
		...
		autoCode[2] = fastDriveStraight + ";" + AutoConstants.BACK_UP_FROM_BOILER_DISTANCE;
	...
	public String[] boilerToMiddleGearRed(){
		...
		autoCode[4] = fastDriveStraight + ";" + AutoConstants.BOILER_TO_MIDDLE_PEG_DISTANCE;
	...
	public String[] middleGearToBoilerRed(){
		...
		autoCode[4] = fastDriveStraight + ";" + AutoConstants.BACK_UP_FROM_PEG_DISTANCE;
		autoCode[5] = getCameraAngle + ";" + AutoConstants.MIDDLE_PEG_TO_BOILER_HARD_ANGLE_RED_ONE;
		autoCode[6] = fastDriveStraight + ";" + AutoConstants.MIDDLE_PEG_TO_BOILER_DISTANCE_ONE;
		autoCode[7] = rocketTurn + ";" + AutoConstants.MIDDLE_PEG_TO_BOILER_HARD_ANGLE_RED_TWO;
		autoCode[8] = fastDriveStraight + ";" + AutoConstants.MIDDLE_PEG_TO_BOILER_DISTANCE_TWO;
		autoCode[9] = shoot + ";" + "0";
		return autoCode;
	}
	...
	public String[] rightGearToBoilerRed(){
		...
		autoCode[6] = fastDriveStraight + ";" + AutoConstants.BACK_UP_FROM_PEG_DISTANCE;
		autoCode[7] = rocketTurn + ";" + AutoConstants.SIDE_PEG_TO_BOILER_ANGLE;
		autoCode[8] = fastDriveStraight + ";" + AutoConstants.SIDE_PEG_TO_BOILER_DISTANCE;
		autoCode[9] = shoot + ";" + "0"; 
		return autoCode;
	}
	...
	public String[] hopperToBoilerRed(){
		...
		autoCode[0] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_1_RED;
		autoCode[1] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_1_RED;
		autoCode[2] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_2_RED;
		autoCode[3] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_2_RED;
		autoCode[4] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_3_RED;
		autoCode[5] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_3_RED;
		autoCode[6] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_4_RED;
		autoCode[7] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_4_RED;
		autoCode[8] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_5_RED;
		autoCode[9] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_5_RED;
		autoCode[10] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_6_RED;
	...
	public String[] hopperToBoilerBlue(){
		String[] autoCode = new String[13];
		autoCode[0] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_1_BLUE;
		autoCode[1] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_1_BLUE;
		autoCode[2] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_2_BLUE;
		autoCode[3] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_2_BLUE;
		autoCode[4] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_3_BLUE;
		autoCode[5] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_3_BLUE;
		autoCode[6] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_4_BLUE;
		autoCode[7] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_4_BLUE;
		autoCode[8] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_5_BLUE;
		autoCode[9] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_5_BLUE;
		autoCode[10] = fastDriveStraight + ";" + AutoConstants.KPA40_DISTANCE_6_BLUE;
		autoCode[11] = rocketTurn + ";" + AutoConstants.KPA40_ANGLE_5_BLUE;
		autoCode[12] = shoot + ";" + 0;
		return autoCode;
	}
}