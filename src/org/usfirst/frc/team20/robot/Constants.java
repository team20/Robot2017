...
public class Constants {
	//CANTalons
	public static final int DRIVETRAIN_MASTER_RIGHT_MOTOR_PORT = 1;
	...
	public static final int DRIVETRAIN_FOLLOWER_RIGHT_MOTOR_PORT_TWO = 3;
	public static final int DRIVETRAIN_FOLLOWER_LEFT_MOTOR_PORT_ONE = 4;
	public static final int DRIVETRAIN_FOLLOWER_LEFT_MOTOR_PORT_TWO = 5;
	public static final int CLIMBER_MASTER_PORT = 6;
	public static final int CLIMBER_FOLLOWER_PORT = 6;
	...
	public static final int FLYWHEEL_FOLLOWER_PORT = 6;
	public static final int HOPPER_COLLECTOR_MOTOR_PORT = 6;
	...
	public static final int HOPPER_EXTEND_PORT = 3;
	public static final int HOPPER_RETRACT_PORT = 4;
	...
	public static final int GEAR_BUMP_SWITCH_PORT_TWO = 0;
}
