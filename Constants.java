...
public class Constants {
	//CANTalons
	public static final int DRIVETRAIN_MASTER_RIGHT_MOTOR_PORT = 3;	//actual port
	public static final int DRIVETRAIN_MASTER_LEFT_MOTOR_PORT = 1;	//actual port
	public static final int DRIVETRAIN_FOLLOWER_RIGHT_MOTOR_PORT = 2;	//actual port
	public static final int DRIVETRAIN_FOLLOWER_LEFT_MOTOR_PORT = 0;	//actual port
	public static final int CLIMBER_MOTOR_PORT = 4;
	public static final int COLLECTOR_MOTOR_PORT = 5;
